  ...
  if (messages.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-full px-6 text-center">
        <div className="flex items-center justify-center w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 mb-5 ring-1 ring-blue-100">
          <Bot className="h-6 w-6 text-blue-600" />
        </div>
        <p className="text-neutral-800 font-semibold text-base mb-1.5">Generate React components</p>
          ...
          >
            {message.role === "assistant" && (
              <div className="flex-shrink-0 mb-0.5">
                <div className="w-7 h-7 rounded-full bg-gradient-to-br from-neutral-100 to-neutral-200 border border-neutral-200 flex items-center justify-center">
                    ...
                    <>
                      {message.parts.map((part, partIndex) => {
                        switch (part.type) {
                          ...
                          case "reasoning":
                            return (
                              <div key={partIndex} className="mt-2.5 p-2.5 bg-neutral-50 rounded-lg border border-neutral-100">
